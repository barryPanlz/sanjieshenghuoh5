	...
	<body>
		...
		<div class="screen">
			...
			<div class="main no_footer_main">
				...
				<p class="upgrade_diamond_p">
					升级之后，您的所有消费数据、操作记录依然保留，但是能得到更多的权限和收益，具体变化请参考下面的对比图：
				</p>
				...
				<div class="upgrade_diamond_cost">
					...
					<ul class="upgrade_diamond_way">
						<p> 支付方式 </p>
						<li> <img id="upgrade_diamond_way_img1" src="../../resources/images/icon_checkbox.png" /> <img src="../../resources/images/zhifubao.png" /> </li>
						<li> <img id="upgrade_diamond_way_img2" src="../../resources/images/icon_checkbox_red.png" /> <img src="../../resources/images/wechat_payment.png" />
							<font> 更快更安全 </font>
						</li>
					</ul>
				</div>
				...
				<ul class="upgrade_suc_even">
					...
					<li> <img src="../../resources/images/red-shibai.png" /> </li>
					<li> <img src="../../resources/images/green-chenggong.png" /> </li>
				</ul>
				<ul class="upgrade_suc_odd">
					<li> 推荐供应商权限 </li>
					<li> <img src="../../resources/images/red-shibai.png" /> </li>
		...
		<script>
			...
			$('.upgrade_diamond_way li').eq(0).click(function() {
				$('#upgrade_diamond_way_img1').attr('src', '../../resources/images/icon_checkbox_red.png');
				$('#upgrade_diamond_way_img2').attr('src', '../../resources/images/icon_checkbox.png');
			});
			$('.upgrade_diamond_way li').eq(1).click(function() {
				$('#upgrade_diamond_way_img1').attr('src', '../../resources/images/icon_checkbox.png');
				$('#upgrade_diamond_way_img2').attr('src', '../../resources/images/icon_checkbox_red.png');
			});
		</script>
	</body>
