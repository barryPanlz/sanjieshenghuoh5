...
<div class="screen">
	...
	<div class="main no_footer_main">
		<div class="sor_top sor1_top">
			<a class="color_green" href="###"><span>全部（</span><span id="stateAll"></span><span>）</span></a>
			<a href="###"><span>待付款（</span><span id="stateNub"></span><span>）</span></a>
...
<!--            --><?php //if(!empty($orderlist->storeOrderList)) {
            //                foreach($orderlist->storeOrderList as $key=>$v){
            //                    foreach($v->order_code_list as $k=>$code) { ?>
            <!--                        <li class="sr_model_li">-->
            <!--                            <span>消费码</span>-->
            <!--                            <input type="hidden" id="store_order_sn" value="--><?php //echo $code->store_order_sn?><!--"/>-->
            <!--                            <input type="number" name="" id="xfcode" value="" placeholder="请输入任意消费码" />-->
            <!--                        </li>-->
            <!--           --><?// } } }?>
            <li class="sr_model_li">
                <span>消费码</span>
<!--                <input type="hidden" id="store_order_sn" value="--><?php //echo empty($code->store_order_sn)?'':$code->store_order_sn?><!--"/>-->
<!--                <input type="hidden" id="currency_type" value="--><?php //echo empty($code->store_order_sn)?'':$code->store_order_sn?><!--"/>-->
