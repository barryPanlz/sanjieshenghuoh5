...
<html>
	...
	<body>
		...
		<div class="main no_footer_main">
			...
			<div class="input_box">
				<div>&nbsp; 充值金额<input type="text" class="num_b1" placeholder="输入金额（三界石）"/></div>
				<div>&nbsp; 需要支付<input type="text" class="num_q1" placeholder="需支付的人民币数额"/></div>
