...
<input class="add_cart" type="button" value="分享获得三界宝" />
...
<input type="text" id="usercode" value="<?php echo empty($usercode) ? '': $usercode; ?>">
		<!--购物成后-->
		<div class="succ">
			<div class="succ_box">
...
//		//加入购物车
        $('.add_cart').click(function() {
            if(onumber==""){
				...
				var biaoji="biaoji";
				sessionStorage.setItem("biaoji",biaoji);
				location.href= "<?php echo Yii::$app->urlManager->createUrl('index/suiyi');?>?code="+onumber;
			}
        })
