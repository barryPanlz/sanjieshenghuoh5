...
<div class="screen">
	<header>
		<h1>安全中心</h1>
		<a class="u_back" href="<?php echo Yii::$app->urlManager->createUrl('supplier/accountset'); ?>">返回</a>
	</header>
		...
		<ul class="security_list">
			<li>
				<div class="list_top">
					...
					<p>
						<a href="<?php echo Url::toRoute("supplier/savepwd");?>">
            ...
            <li>
                <div class="list_top">
                    ...
                    <img src="<?php echo $pc_style; ?>images/icon26.png" alt="">
                    <p>
                        <a href="<?php echo Url::toRoute("supplier/withdrawalset");?>">
                            <img src="<?php echo $pc_style; ?>images/edit.png" alt="">
                            <span> 修改 </span>
                        </a>
                    </p>
