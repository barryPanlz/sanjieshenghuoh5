...
<!--		<a class="u_back" href="javascript:history.go(-1)">返回</a>-->
	...
	<div class="main">
		...
		<div class="list">
			<ul>
				<li>
					<a href="<?php echo Yii::$app->urlManager->createUrl('agent/mystore');?>">
						<div class="icon"><img src="<?php echo $pc_style; ?>images/icon13.png" alt=""></div>
						<p class="name">我辖区的店铺</p>
						<span class="arrow"><img src="<?php echo $pc_style; ?>images/back.png" alt=""></span>
					</a>
				</li>
				<li>
					<a href="<?php echo Yii::$app->urlManager->createUrl('agent/genacc');?>">
				...
				<li>
					<a href="<?php echo Yii::$app->urlManager->createUrl('agent/accountset');?>">
		...
		<div class="list">
			<ul>
				<li>
					<a href="<?php echo Yii::$app->urlManager->createUrl('agent/share');?>">
				...
				<li>
					<a href="<?php echo Yii::$app->urlManager->createUrl('agent/aboutus');?>">
...
$(".aaa").click(function(){
    ...
    $('.quite_sure').click(function(event) {
        location.href="<?php echo \Yii::$app->urlManager->createUrl(['agent/out']);?>";
    });
</script>
</body>
</html>